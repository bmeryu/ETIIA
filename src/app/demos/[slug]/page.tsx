...
const demos: Record<string, {
  ...
  atendeai: {
    ...
    seoTitle: "AtendeAI: Agente IA de Atención al Cliente | ETIIA",
  ...
  ventaai: {
    ...
    seoTitle: "VentaAI: Motor de Recomendación eCommerce | ETIIA",
  ...
  facturai: {
    ...
    seoTitle: "FacturAI: Conciliación de Facturas con OCR | ETIIA",
  ...
  autorend: {
    ...
    seoTitle: "AutoRend: IA para Rendiciones Educativas | ETIIA",
  ...
  lexsearch: {
    ...
    seoTitle: "LexSearch: Buscador Semántico Jurídico | ETIIA",
  ...
  talentparse: {
    ...
    seoTitle: "TalentParse: IA para Screening de CVs | ETIIA",
  ...
  agendai: {
    ...
    seoTitle: "AgendAI: Predicción de Inasistencias Médicas | ETIIA",
  ...
  cosechai: {
    ...
    seoTitle: "CosechAI: IA Predictiva para Agricultura | ETIIA",
  ...
  transcribai: {
    ...
    seoTitle: "TranscribAI: Transcripción Whisper V3 B2B | ETIIA",
  ...
  prospectai: {
    ...
    seoTitle: "ProspectAI: Outbound y Prospección B2B | ETIIA",
