...
export const metadata = {
    title: "Equipo | ETIA",
    description: "Conoce al equipo de ETIA. Unimos estrategia comercial con ingeniería robusta para resolver desafíos con IA.",
};
            ...
            <section className="container mx-auto px-6 md:px-12 mb-20 text-center max-w-4xl">
                ...
                <FadeIn delay={0.35}>
                    <p className="text-lg text-slate-500 max-w-2xl mx-auto leading-relaxed">
                        ETIA nace de una convicción: la IA solo genera valor cuando la estrategia comercial y la ingeniería trabajan como una sola unidad. Sin traducciones. Sin brechas.
                    </p>
                </FadeIn>
            </section>
                ...
                <div className="container mx-auto px-6 md:px-12 max-w-4xl">
                    ...
                    <div className="space-y-10">
                        <FounderCard
                            ...
                            imageSrc="/berni.jpg"
                            imageAlt="Bernardita Mery Undurraga - CEO de ETIA"
                        ...
                        <FounderCard
                            ...
                            imageSrc="/pablo.jpg"
                            imageAlt="Pablo E. Olivares - CTO de ETIA"
            ...
            <section className="py-20 bg-slate-50 border-y border-slate-100">
                <div className="container mx-auto px-6 md:px-12 max-w-4xl">
                    ...
                    <div className="space-y-6 text-base text-slate-600 leading-relaxed">
                        <Reveal delay={0.1}>
                            <p>
                                ETIA nació de una frustración compartida: la profunda desconexión entre los "laboratorios de innovación" tecnológicos y el directorio comercial. Tras presenciar múltiples inversiones millonarias en Data & AI que terminaban en modelos que nadie usaba, Bernardita y Pablo decidieron estructurar una solución definitiva.
                            </p>
                        </Reveal>
                        <Reveal delay={0.2}>
                            <p>
                                Lo que comenzó como una consultoría de nicho para alinear arquitecturas cloud con estrategias de ventas, rápidamente escaló. En menos de dos años, ETIA pasó de optimizar flujos de datos en empresas medianas, a construir y desplegar motores de IA transaccionales para líderes del mercado financiero e industrial.
                            </p>
                        </Reveal>
                        <Reveal delay={0.3}>
                            <p>
                                Hoy, ETIA es una firma de consultoría e implementación de IA que asegura que antes de escribir una línea de código, el modelo de negocio esté matemáticamente justificado. La base es full aplicación de IA.
                            </p>
                        </Reveal>
                    </div>
                </div>
